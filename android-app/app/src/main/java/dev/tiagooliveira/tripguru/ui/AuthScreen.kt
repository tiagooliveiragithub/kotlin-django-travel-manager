...
import dev.tiagooliveira.tripguru.ui.destinations.AuthScreenDestination
import dev.tiagooliveira.tripguru.ui.destinations.SecretScreenDestination
...
fun AuthScreen(
    ...
    LaunchedEffect(viewModel, context) {
        viewModel.authResults.collect { result ->
            when(result) {
                is dev.tiagooliveira.tripguru.auth.AuthResult.Authorized -> {
                ...
                is dev.tiagooliveira.tripguru.auth.AuthResult.Unauthorized -> {
                    Toast.makeText(
                        context,
                ...
                is dev.tiagooliveira.tripguru.auth.AuthResult.UnknownError -> {
                    Toast.makeText(
                        context,
